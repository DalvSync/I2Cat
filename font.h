...
//Font 6x8 (Width 6, Height 8)
//The first 4 bytes are service information, the font itself starts from the 5th byte.
const uint8_t font6x8[] PROGMEM =
{
  0x00, 0x06, 0x08, 0x20, // Header: [Junk], [Width], [Height], [StartChar]
